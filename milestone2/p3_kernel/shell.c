...
main(){
	...
	prnt("\r\n\0");
	prnt("Creator By. \r\n\0");
	prnt("Ari Bambang K (14115062) \r\n\0");
	prnt("Putra Abi A (14115011) \r\n\0");
	prnt("Irfan Gerard W (14115016) \r\n\0");
	prnt("Selamat datang di terminal p3_kernel\r\n\0");
